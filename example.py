...
import random
random.seed(2147483611) # with this seed Packet SN=19 is lost on Link L1
...
hostA = Host(sim, 'A', mode=ReliabilityMode.NO_RELIABILITY)
hostA.add_nic(nicA)
nicA.attach(L1)
...
hostB = Host(sim, 'B', mode=ReliabilityMode.NO_RELIABILITY)
hostB.add_nic(nicB)
nicB.attach(L2)
